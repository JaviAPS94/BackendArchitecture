...
The goal is to develop a Backend system from scratch, carrying out the interpretation of "business requirements" until its implementation, and it should be done taking into account the planning of an architecture that details at a high level how the proposed system meets with the use cases derived from the requirements.
